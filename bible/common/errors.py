...
class ErrorCode(str, Enum):
    ...
    INDEX_NOT_BOUND = "INDEX_NOT_BOUND"
    DATABASE_BACKEND_UNAVAILABLE = "DATABASE_BACKEND_UNAVAILABLE"
    DATABASE_INVALID_ARGUMENT = "DATABASE_INVALID_ARGUMENT"
    DATABASE_WRITE_PARTIAL_FAILED = "DATABASE_WRITE_PARTIAL_FAILED"
    FILE_STORE_FAILED = "FILE_STORE_FAILED"
    FILE_NOT_FOUND = "FILE_NOT_FOUND"
    FILE_DELETE_FAILED = "FILE_DELETE_FAILED"
    INVALID_STORAGE_PATH = "INVALID_STORAGE_PATH"
    FILE_SYSTEM_BACKEND_UNSUPPORTED = "FILE_SYSTEM_BACKEND_UNSUPPORTED"
    FILE_REGISTRY_NOT_FOUND = "FILE_REGISTRY_NOT_FOUND"
...
ERROR_HTTP_STATUS_MAP: dict[ErrorCode, int] = {
    ...
    ErrorCode.INDEX_BINDING_CONFLICT: 409,
    ErrorCode.INDEX_NOT_BOUND: 404,
    ErrorCode.DATABASE_BACKEND_UNAVAILABLE: 503,
    ErrorCode.DATABASE_INVALID_ARGUMENT: 400,
    ErrorCode.DATABASE_WRITE_PARTIAL_FAILED: 500,
    ErrorCode.FILE_STORE_FAILED: 500,
    ErrorCode.FILE_NOT_FOUND: 404,
    ErrorCode.FILE_DELETE_FAILED: 500,
    ErrorCode.INVALID_STORAGE_PATH: 400,
    ErrorCode.FILE_SYSTEM_BACKEND_UNSUPPORTED: 400,
    ErrorCode.FILE_REGISTRY_NOT_FOUND: 404,
}
